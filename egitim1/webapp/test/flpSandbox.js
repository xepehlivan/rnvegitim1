		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Eğitim 1 ",
									"targetURL": "#renovaegitim1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"renovaegitim1-display": {
								"semanticObject": "renovaegitim1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=renova.egitim1",
									"url": sap.ui.require.toUrl("renova/egitim1")
								}
							}
						}
					}
